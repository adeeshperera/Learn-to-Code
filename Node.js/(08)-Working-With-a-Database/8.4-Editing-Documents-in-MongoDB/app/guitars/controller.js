...
// Updating a guitar's details based on data received in a request
export async function updateGuitar(req, res) {
	...
	if (guitar_make && guitar_model) {
		await saveGuitar(id, guitar_make, guitar_model); // Update the guitar details in the database
...
// Checks if a given ID is likely valid and if the length of the id string is exactly 24 characters
