...
public class MyFirstJavaApplication {
    ...
    // String[] args: This is an array of String objects that can hold command-line arguments passed to the program when it is run (args is a parameter that stands for "arguments")
