...
</ul>`; // Displaying all existing guitars (Unordered (bulleted) list)

const createListItem = ({ id, make, model }) =>
	`<li><a href="?id=${id}">${make} ${model}</a></li>`; // Items
...
// Display the guitar using ID - getGuitarContent(guitar);
...
// Basic structure of content - view(content);
